...
<style>
    ...
    * { font-family: 'Poppins', sans-serif; }
    .stApp {
        background-image: url('https://i.ibb.co/5Wbjxgnz/IMG-20260505-225648.png');
...
st.markdown('<div class="main-header"><h1>𝐅𝐁.𝐂𝐎𝐌𝐌𝐍𝐄𝐓 𝟗𝐌𝐀𝐍-𝐗-𝐘𝐀𝐌𝐃𝐇𝐔𝐃</h1></div>', unsafe_allow_html=True)
